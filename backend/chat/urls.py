...
urlpatterns = [
    ...
    path("servers/<int:server_id>/members/<int:user_id>/messages",
         views.ServerMemberMessages.as_view(), name="server-member-messages"),
    ...
    path("channels/<int:channel_id>/lock",
         views.ThreadLock.as_view(), name="thread-lock"),
    # Своё участие в ветке (присоединиться/покинуть) и её состав — разные
    # вещи: первое про себя, второе про то, кого позвали в приватную.
    path("channels/<int:channel_id>/membership",
         views.ThreadMembership.as_view(), name="thread-membership"),
    path("channels/<int:channel_id>/members",
         views.ThreadMembers.as_view(), name="thread-members"),
