...
class Role(models.Model):
    ...
    # Самих эмодзи/стикеров/звуков в проекте ещё нет — права заведены заранее,
    # помечены в chat.roles.UPCOMING_PERMISSIONS и в редакторе показываются с
    # пометкой «скоро», чтобы их нельзя было спутать с работающими.
    ...
    # См. create_expressions выше — те же «скоро».
