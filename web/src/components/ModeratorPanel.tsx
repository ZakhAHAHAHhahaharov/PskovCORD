 ...
 * FriendContextMenu).
 *
 * Встаёт отдельной колонкой ПРАВЕЕ списка участников (как в Discord), а не
 * подменяет его собой: модерируя человека, обычно надо видеть и остальной
 * ростер — кто ещё онлайн, кому эта же роль уже выдана. Раскладку задаёт
 * грид .app — четвёртая колонка появляется вместе с панелью (см. index.css).
 *
